...
export interface IoPoint extends CoatyObject {
     ...
     * internal IO actors or from internal IO sources to external sinks
     * (optional).
     *
     * Used only for predefined external topics that are not generated by the IO
     * router dynamically, but defined by an external (i.e. non-Coaty) component
     * instead.
     */
...
export interface IoActor extends IoPoint {
    ...
    /**
     * Determines whether IO values (generated by external sources) should be
     * treated as raw data that is non encoded/decoded as JSON objects.
     *
